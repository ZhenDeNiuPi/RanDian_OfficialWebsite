const slideData = [
{
  ...
  headline: '山建教务入口',
  button: 'Shop now',
  src: 'images/sjjw/sy.jpg' },

{
  index: 1,
  headline: '用户管理',
  button: 'Shop now',
  src: 'images/sjjw/yhgl.png' },

{
  index: 2,
  headline: '角色管理',
  button: 'Shop now',
  src: 'images/sjjw/jsgl.png' },

  {
    index: 3,
    headline: '公告管理',
    button: 'Shop now',
    src: 'images/sjjw/gggl.png' },

    {
      index: 4,
      headline: '部门管理',
      button: 'Shop now',
      src: 'images/sjjw/bmgl.png' },

      {
        index: 5,
        headline: '修改用户信息',
        button: 'Shop now',
        src: 'images/sjjw/yhxq.png' },

        {
          index: 6,
          headline: '个人信息',
          button: 'Shop now',
          src: 'images/sjjw/grxx.png' },

          {
            index: 7,
            headline: '菜单管理',
            button: 'Shop now',
            src: 'images/sjjw/cdgl.png' }
  ];
