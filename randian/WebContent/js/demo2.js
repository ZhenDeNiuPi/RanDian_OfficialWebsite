 ...
 */
{
        ...
        calcTransforms() {
            ...
            */
            this.transforms = [
                ...
                {x: -1*(winsize.width/2+this.width-103), y: -1*(winsize.height/2-this.height/3), rotation: 0},
                {x: -72, y: 0, rotation: 0},
                {x: winsize.width/2+this.width-247, y: winsize.height/2-this.height/3, rotation: 0},
    ...
    class Content {
        ...
        show() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.number,this.DOM.title,this.DOM.subtitle1,this.DOM.subtitle,this.DOM.text], 0.8, {
                ease: Power4.easeOut,
                delay: 0.4,
                opacity: 1,
                startAt: {y: 40},
        ...
        hide() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.number,this.DOM.title,this.DOM.subtitle1,this.DOM.subtitle,this.DOM.text].reverse(), 0.3, {
                ease: Power3.easeIn,
                opacity: 0,
                y: 10
            }, 0.01);
