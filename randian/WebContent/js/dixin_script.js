const slideData = [
{
  ...
  headline: '滴信后台用户管理',
  button: 'Shop now',
  src: 'images/dixin/滴信后台用户管理.png' },

{
  index: 1,
  headline: '滴信后台活动管理',
  button: 'Shop now',
  src: 'images/dixin/滴信后台活动管理.png' },

{
  index: 2,
  headline: '滴信后台捐赠管理',
  button: 'Shop now',
  src: 'images/dixin/滴信后台捐赠管理.png' },

{
  index: 3,
  headline: '滴信后台租房管理',
  button: 'Shop now',
  src: 'images/dixin/滴信后台租房管理.png' },

{
	index: 4,
	headline: '滴信后台通知管理',
	button: 'Shop now',
	src: 'images/dixin/滴信后台通知管理.png' },

{
	index: 5,
	headline: '滴信小程序首页',
	button: 'Shop now',
	src: 'images/dixin/滴信小程序1.png' },
{
	index: 6,
	headline: '滴信小程序活动详情',
	button: 'Shop now',
	src: 'images/dixin/滴信小程序2.png' },
{
	index: 7,
	headline: '滴信小程序大学生计划',
	button: 'Shop now',
	src: 'images/dixin/滴信小程序3.png' },
{
	index: 8,
	headline: '滴信小程序个人中心',
button: 'Shop now',
src: 'images/dixin/滴信小程序4.png' },
{
	index: 9,
	headline: '滴信小程序用户签到',
	button: 'Shop now',
	src: 'images/dixin/滴信小程序5.png' },
  ];
